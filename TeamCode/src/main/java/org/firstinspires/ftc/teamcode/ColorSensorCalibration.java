...
public class ColorSensorCalibration extends OpMode implements I2cPortReadyCallback{

    // IMPORTANT!
    // What did you name your color sensor in the Robot Controller config?
    String color_sensor_name = "Map";
    ...
    public byte COLOR_SENSOR_ADDR = 0x1e;
     ...
     * as a callback.
     */
//comm.qualcomm.robotcore.hardware.I2cController
    ...
    public void init() {
        ...
        //getI2cController
        controller = color_sensor.getI2cController;//getI2cController is what was there before
