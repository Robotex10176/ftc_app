...
/**
 * Created by Eric D'Urso on 11/6/2017.
 */

public class BSA_Methods
{
    ...
    public void TurnRight(float Angle, double Power){//turn right is clockwise
        //code to turn untill an angle ex 0, 90, -90
        float zAngle;
        float targetAngle;                                                               //Gots 2 b positive for buth
    ...
    public void TurnLeft (float Angle, double Power){
        float zAngle;
        float targetAngle;
    ...
    public void Drive (double DesiredDistance, double Power){
        ...
        final double WHEEL_DIAMETER_INCHES = 3.00;
